...
Dùng wget:
```
wget --no-check-certificate "https://raw.githubusercontent.com/lucbadaitu/rom/main/romtimes" -O /usr/bin/times-openwrt && chmod +x /usr/bin/jam.sh
```

dùng curl:
```
curl -sL https://raw.githubusercontent.com/lucbadaitu/rom/main/romtimes > /usr/bin/times-openwrt && chmod +x /usr/bin/jam.sh
```
